...
func diagnosticIntelligencePayload(investigation *domain.Investigation) map[string]any {
	...
	return map[string]any{
		...
		"hypothesis_comparisons":       investigation.HypothesisComparisons,
		...
		"diagnosis_validations":        investigation.DiagnosisValidations,
