...
func TestRunner(t *testing.T) {
	...
	client := &fakeClient{in: &domain.Incident{ID: "i", Status: domain.StatusNeedsAttention, RootCauseCategory: "cpu", RootCauseVariant: "busy_loop", Service: "payment-service", Resource: "payment-service", RootCauseEvidenceIDs: []string{"e1"}, Evidence: []domain.Evidence{{ID: "e1", Kind: "cpu"}}}}
